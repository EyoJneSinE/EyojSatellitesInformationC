...
import com.eniskaner.eyojsatellitesinformation.core.data.Constants.UIConstants.SATELLITE_STATUS_ICON
    ...
    Column(
        ...
        Row(
            ...
            Icon(
                ...
                contentDescription = SATELLITE_STATUS_ICON
            )
            ...
            Column(
                ...
                val textStatusColor =
                    if (satellite.isActive) Gray400 else Gray400.copy(alpha = 0.5f)
                Text(
                    text = satellite.name,
                ...
                Text(
                    text = if (satellite.isActive) stringResource(Res.string.active_status) else stringResource(
                        Res.string.passive_status
                    ),
